          ...
          <div>
            ...
            <div className="card">
                ...
                {weeklyAttendance.map((day) => {
                  ...
                  return (
                    <div className="bar-col" key={day.day}>
                      <div
                        className="bar-stack"
                        style={{ height: `${total * chartScale}px` }}
                      >
                        <div
                          style={{
                            height: `${day.leave * chartScale}px`,
                            background: "var(--blue)",
                          }}
                        />
                        <div
                          style={{
                            height: `${day.absent * chartScale}px`,
                            background: "var(--red)",
                          }}
                        />
                        <div
                          style={{
                            height: `${day.late * chartScale}px`,
                            background: "var(--yellow)",
                          }}
                        />
                        <div
                          style={{
                            height: `${day.onTime * chartScale}px`,
              ...
              <div className="legend">
                <span>
                  <i className="on-time"></i>On-Time
                </span>
                <span>
                  <i className="late"></i>Late
                </span>
                <span>
                  <i className="absent"></i>Absent
                </span>
                <span>
                  <i className="leave"></i>Leave
                </span>
              </div>
            </div>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <span
                          ...
                          style={{
                            background:
                              ATTENDANCE_STATUS_COLOR[employee.status],
                          }}
                        />
                        {employee.status}
                      </td>
            ...
            <div className="card">
              ...
              <div className="cal-grid">
                ...
                {leadingDays.map((day, index) => (
                  <div className="day muted" key={`lead-${index}`}>
                    {day}
                  </div>
                ))}
                {monthDays.map((day) => (
                  <div
                    className={`day ${day === todayDate ? "today" : ""}`}
                    key={day}
                  >
                    {day}
                  </div>
              ...
              <div>
                {leaveRequests.map((leave, index) => (
                  <div className="leave-item" key={index}>
                    ...
                    <span
                      className="tag"
                      style={{ background: LEAVE_TYPE_COLOR[leave.type] }}
                    >
                      {leave.type}
                    </span>
